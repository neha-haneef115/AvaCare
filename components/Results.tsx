  ...
  return (
    <div className="max-w-4xl mx-auto bg-white border-2 border-black rounded-lg overflow-hidden mb-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      <div className="p-4 bg-[#f8fed5] border-b-2 border-black">
        ...
        <p className="text-sm font-medium">AI-powered differential diagnosis with confidence scoring</p>
      </div>
        ...
        <div className="p-4 bg-red-50 border-2 border-red-200 rounded-lg text-sm font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-red-700 mt-1">This AI analysis is for informational purposes only. It is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of qualified healthcare professionals for any health concerns.</p>
            </div>
          </div>
        </div>
      </div>
